    ...
    <>
      <div className="navbar">
        <nav>
          ...
          <Link className="btn ton-connect-trigger"></Link>
          </div>
        </nav> 
      </div>
      {/* Header */}
        ...
        <div className="container">
          <header className="header">
            <div className="header-word">
              ...
              <div className="ton-connect-button">
              <Link className="ton-connect-trigger">Connect Wallet</Link>
              </div>
            </div>
          ...
          <div className="explore">
            ...
            <div className="card-container">
              ...
              <div className="card" data-aos="fade-right">
                ...
                <button  className="card-button ton-connect-trigger">More info</button>
              </div>
              {/* end1 */}
              {/* start1 */}
              <div className="card" data-aos="fade-up">
                ...
                <button className="ton-connect-trigger card-button">More info</button>
              </div>
              {/* end1 */}
              {/* start1 */}
